            ...
            steps {
                script {
                    try {
                        ...
                        sh 'docker run -t --rm --network danielarc_default --link jenkins_gateway_1:gateway -e GATEWAY_PORT_80_HTTP=http://gateway index.alauda.cn/alaudaorg/tasks-integration:latest'
                    } finally {
